...
export default function TreasuryDashboard() {
  ...
  const [form, setForm] = useState({ token: "", paymentMethod: "VIREMENT_BANCAIRE", currency: "FRANC", paymentCountry: "DJIBOUTI", amount: 1, bankCountry: "DJIBOUTI", bankName: "CAC Bank", bankReference: "", bankAccountHolder: "" });
  ...
  function openOrder(expense) {
    ...
    setForm({ token: "", paymentMethod: "VIREMENT_BANCAIRE", currency: "FRANC", paymentCountry: expense.beneficiaryCountry || "DJIBOUTI", amount: expense.amount || 1, bankCountry: expense.beneficiaryCountry || "DJIBOUTI", bankName: bankOptionsByCountry[expense.beneficiaryCountry || "DJIBOUTI"][0], bankReference: "", bankAccountHolder: expense.beneficiaryName || "" });
  }

  function setPaymentMethod(paymentMethod) {
    if (paymentMethod === "CASH") {
      setForm({ ...form, paymentMethod, bankCountry: "", bankName: "", bankReference: "", bankAccountHolder: "" });
      return;
    }
    const bankCountry = form.bankCountry || form.paymentCountry || "DJIBOUTI";
    setForm({ ...form, paymentMethod, bankCountry, bankName: form.bankName || bankOptionsByCountry[bankCountry][0] });
  }

  function setBankCountry(bankCountry) {
    setForm({ ...form, bankCountry, bankName: bankOptionsByCountry[bankCountry][0] });
  }
