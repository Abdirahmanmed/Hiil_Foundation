...
export default function ExpenseManagerDashboard() {
  ...
  const createMut = useMutation({
    ...
    onError: (e) => toast.error(e?.response?.data?.message || "Erreur création dépense"),
  });
