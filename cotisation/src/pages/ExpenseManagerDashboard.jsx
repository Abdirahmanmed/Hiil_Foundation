...
export default function ExpenseManagerDashboard() {
  ...
  const expenseTotalsChartData = useMemo(() => [
    { name: "Mois", value: Number(stats?.monthExpensesAmount || 0) },
    { name: "Total", value: Number(stats?.totalExpenses || 0) },
  ], [stats]);
